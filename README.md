...
**Code an Agent That Learns a Maze — QuietLoom AI Lab / Alex Mercer**
...
- **Why does the agent keep choosing left?** Reproduce the tied-value bug, repair random tie-breaking, and test epsilon exploration. Seven runnable checkpoints distinguish action selection from learned success.
...
These examples run on the CPU. The pack also includes the exact final files typed in the recordings under `recorded/`. The RL helper-in-environment checkpoint demonstrates real state transitions without training.

- [Watch: Why Your AI Agent Only Goes Left (Python Fix)](https://www.youtube.com/watch?v=AixQBxTEcbU)
- [Watch: 99% Accurate, Still Useless? Test It in Python](https://www.youtube.com/watch?v=UujLg6pigU0)

Watch first, pause at the prediction checkpoint, then compare your file with the numbered examples. The complete RL workshop remains linked below.
...
[QuietLoom AI Lab](https://www.youtube.com/@quietloom-media)
